...
public class ChatClient2MIDlet extends MIDlet implements CommandListener {
	...
	public ChatClient2MIDlet() {
		display = Display.getDisplay(this);
		form = new Form("Chat Client2");
	...
	class ClientThread implements Runnable {
		public ClientThread() {
			...
			try {
				String url = "socket://127.0.0.2:9999";
