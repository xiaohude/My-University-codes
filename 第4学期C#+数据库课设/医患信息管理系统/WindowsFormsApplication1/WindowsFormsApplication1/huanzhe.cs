...
{
    public partial class huanzhe : Form
    {
        ...
        {
            s.Open();
            string sql = "select num 编号,name 患者姓名,sex 性别,age 年龄,telephone 联系方式 from yy_huanzhe where num='"+num+"'";
        ...
        private void button4_Click(object sender, EventArgs e)//保存按钮
        {
            s.Open();
            getmessage();
            string sql = "update yy_huanzhe set name='" + name + "',sex='" + sex + "',age='" + age + "',telephone='" + telephone + "' where num='" + num + "'";
        ...
        {
            kanyisheng kys = new kanyisheng(num);
            kys.ShowDialog();
        }
    }
}
